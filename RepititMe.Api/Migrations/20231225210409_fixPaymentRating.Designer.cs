...
namespace RepititMe.Api.Migrations
{
    ...
    [Migration("20231225210409_fixPaymentRating")]
    partial class fixPaymentRating
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RepititMe.Domain.Entities.Users.Teacher", b =>
                {
                    ...
                    b.Property<double>("PaymentRatingFromCommission")
                        .HasColumnType("double precision");

                    b.Property<double>("PaymentRatingFromProfile")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("RepititMe.Domain.Entities.Weights.Order", b =>
                {
                    ...
                    b.Property<bool>("NotificationTimeAccept")
                        .HasColumnType("boolean");

                    b.Property<bool>("NotificationTimeFirstLesson")
                        .HasColumnType("boolean");

                    b.Property<double>("PaidCommission")
                        .HasColumnType("double precision");
